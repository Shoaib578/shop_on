...
export default class SendItemProduct extends React.Component {
    render(){
        return(
            <View style={styles.container}>

            
            <TouchableWithoutFeedback  onPress={()=>this.props.navigation.navigate('select_user',{id:this.props.data.item._id})}>
